...
#
# При сборе данных учесть, что полученный из данных автор уже может быть
# в БД и значит необходимо это заблаговременно проверить.
